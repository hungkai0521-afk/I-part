    ...
    <div class="col-md-8">
                        ...
                        <table class="table table-hover align-middle mb-0 mounted-table" id="outTable">
                            <thead class="table-light sticky-top">
                                <tr>
                                    ...
                                    <th>機台 (Tool)</th><th>料號 (Part No)</th><th>品名 (Name)</th><th>分類</th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        <div class="card shadow-sm border-0" id="formCard">
            <div class="card-header bg-white fw-bold py-3 border-bottom d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="http://【請修改這裡_填入_IPART_網址】" target="_blank" class="btn btn-sm btn-outline-primary me-1"><i class="fas fa-external-link-alt me-1"></i> iPart 系統</a>
                    <a href="http://【請修改這裡_填入_待建料DB_網址】" target="_blank" class="btn btn-sm btn-outline-secondary"><i class="fas fa-database me-1"></i> 待建料 DB</a>
                </div>
            </div>
            ...
            <div class="card-body p-4 bg-light bg-opacity-25">
                <form id="opsForm" method="POST">
                    ...
                    <?php if ($status == 'ON'): ?>
                    <div class="mb-3">
                        <label class="form-label fw-bold text-dark">PART 分類 <span class="text-danger">*</span></label>
                        <select name="category" class="form-select" required>
                            <option value="">-- 請選擇分類 (必填) --</option>
                            <option value="Contract Tool Part">Contract Tool Part</option>
                            <option value="Warranty Tool Part">Warranty Tool Part</option>
                            <option value="Consumables Part">Consumables Part</option>
                        </select>
                        <div class="invalid-feedback">請選擇 PART 分類。</div>
                    </div>
                    <?php endif; ?>
...
<script>
    ...
    <?php if ($status == 'OUT'): ?>
        ...
        function showConfirmModal() {
            ...
            if (checkboxes.length === 0) { alert('請至少選擇一筆！'); return; }
